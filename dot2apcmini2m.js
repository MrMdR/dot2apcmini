...
if (page > 0) {
    output.send('noteon', { note: 82, velocity: 0, channel: 0 }); // origional: verlocity:1;.But since the page selection is not working, i turnd off the ledlight of the first button.
